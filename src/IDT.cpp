...
void (*handlers[IDT_DESCRIPTORS_COUNT])(void) = {
        ...
        nullptr,                                 // |    6   |   #UD    | Invalid Opcode (Undefined Opcode)          | Fault      | No         | UD instruction or reserved opcode.
        ...
        nullptr,                                 // |   14   |   #PF    | Page Fault                                 | Fault      | Yes        | Any memory reference.
...
IDTDescriptor createDescriptor(void (*handler)()) {
